...
//
// TODO(chai2010): We may be able to merge various of the memory operands
...
// TODO(chai2010): This is for testing. Only use this if a flag is given.
...
func decode1(src []byte, mode int, gnuCompat bool) (Inst, error) {
	...
	case 16, 32, 64:
		// ok
		// TODO(chai2010): 64-bit mode not tested, probably not working.
	default:
...
Decode:
	for pc := 1; ; { // TODO uint
		...
		case xArgMoffs8, xArgMoffs16, xArgMoffs32, xArgMoffs64:
			// TODO(chai2010): Can address be 64 bits?
		...
		case xArgMm2: // register only; TODO(chai2010): Handle with tag modrm_regonly tag
			if haveMem {
				inst.Op = 0
				break Decode
			}
		...
		case xArgXmm2: // register only; TODO(chai2010): Handle with tag modrm_regonly tag
			if haveMem {
				inst.Op = 0
				break Decode
			}
	...
	// TODO(chai2010): Perhaps add these to the tables and
	...
	// TODO(chai2010): Perhaps this instruction class should be derived from the CSV.
