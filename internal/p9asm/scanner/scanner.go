...
import (
	...
	"wa-lang.org/wa/internal/p9asm/token"
)
...
// the offending token.
type ErrorHandler func(pos objabi.Position, msg string)
...
type Scanner struct {
	...
	// immutable state
	file *objabi.File // source file handle
...
// of the file.
func (s *Scanner) Init(arch objabi.CPUType, file *objabi.File, src []byte, err ErrorHandler, mode Mode) {
...
func (s *Scanner) Scan() (pos objabi.Pos, tok token.Token, lit string) {
scanAgain:
	s.skipWhitespace()
