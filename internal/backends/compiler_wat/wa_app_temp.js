  ...
  constructor(url) {
    ...
    WebAssembly.instantiateStreaming(fetch(url), imports).then(res => {
      ...
      Object.defineProperty(this, "I", {
        get: function() { return this._mem_util.i32_load(this._wasm_inst.exports["__main__.I.1"]); },
        set: function (v) { this._mem_util.i32_store(this._wasm_inst.exports["__main__.I.1"], v); },
      });

      Object.defineProperty(this, "S", {
        get: function() { return this._mem_util.string_load(this._wasm_inst.exports["__main__.S.1"]); },
        set: function(v) { this._mem_util.string_store(this._wasm_inst.exports["__main__.S.1"], v); }
      });

      // 全局函数：
      this.Fn1 = function() {
        this._wasm_inst.exports["__main__.Fn1"]()
      }

      this.Fn2 = function(p0, p1) {
        let params = [];
        let $p0 = this._mem_util.set_string(p0);
        params = params.concat($p0);
        params.push(p1);

        let $r = this._wasm_inst.exports["__main__.Fn2"](...params);
        
        let r0 = this._mem_util.extract_string($r);
        let r1 = this._mem_util.extract_i32($r);
        let r2 = this._mem_util.extract_string($r);
      ...
      this.Fn3 = function() {
        this._wasm_inst.exports["__main__.Fn3"]()
      }
