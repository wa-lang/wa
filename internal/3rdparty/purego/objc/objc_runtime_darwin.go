...
import (
	...
	"wa-lang.org/wa/internal/3rdparty/purego"
)
...
//func Send[T any](id ID, sel SEL, args ...interface{}) T {
//	var fn func(id ID, sel SEL, args ...interface{}) T
//	var zero T
//	if runtime.GOARCH == "amd64" &&
...
// This function takes a SEL instead of a string since RegisterName grabs the global Objective-C lock.
// It is best to cache the result of RegisterName.
//func SendSuper[T any](id ID, sel SEL, args ...interface{}) T {
//	super := &objc_super{
//		receiver:   id,
//		superClass: id.Class(),
//	}
//	var fn func(objcSuper *objc_super, sel SEL, args ...interface{}) T
//	var zero T
//	if runtime.GOARCH == "amd64" &&
//		reflect.ValueOf(zero).Kind() == reflect.Struct &&
//		reflect.ValueOf(zero).Type().Size() > maxRegAllocStructSize {
