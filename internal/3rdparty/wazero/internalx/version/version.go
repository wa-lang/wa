...
// This assumes that users of wazero imports wazero as "wa-lang.org/wa/internal/3rdparty/wazero".
...
func GetWazeroVersion() (ret string) {
	...
	if ok {
		for _, dep := range info.Deps {
			...
			if strings.Contains(dep.Path, "wa-lang.org/wa/internal/3rdparty/wazero") {
				ret = dep.Version
			}
		}
	}
