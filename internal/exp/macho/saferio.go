...
func saferio_SliceCapWithSize(size, c uint64) int {
...
func saferio_SliceCap_FatArch(c uint64) int {
	var v FatArch
	size := uint64(unsafe.Sizeof(v))
	return saferio_SliceCapWithSize(size, c)
}

func saferio_SliceCap_Load(c uint64) int {
	var v Load
	size := uint64(unsafe.Sizeof(v))
	return saferio_SliceCapWithSize(size, c)
}

func saferio_SliceCap_Symbol(c uint64) int {
	var v Symbol
	size := uint64(unsafe.Sizeof(v))
	return saferio_SliceCapWithSize(size, c)
}
