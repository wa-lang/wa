...
.L.if.begin..00000018:
    mov eax, [rbp+0]
    test eax, eax
    jne .L.if.body..00000018 # if eax != 0 { jmp body }
.L.if.body..00000018:
.L.if.else..00000018:
    call .Runtime.panic # unreachable
.L.next..00000018:
...
.L.if.begin..0000001A:
    mov eax, [rbp-8]
    test eax, eax
    jne .L.if.body..0000001A # if eax != 0 { jmp body }
.L.if.body..0000001A:
    # i32.const 0
    mov eax, 0
    mov [rbp-16], eax
...
.L.if.begin..0000001C:
    mov eax, [rbp+0]
    test eax, eax
    je .L.if.end..0000001C # if eax != 0 { jmp end }
.L.if.body..0000001C:
    call .Runtime.panic # unreachable
.L.next..0000001C:
.L.if.end..0000001C:
...
.L.if.begin..0000001E:
    mov eax, [rbp-8]
    test eax, eax
    jne .L.if.body..0000001E # if eax != 0 { jmp body }
.L.if.body..0000001E:
.L.if.else..0000001E:
    # i32.const 0
    mov eax, 0
...
.L.if.begin..00000024:
    mov eax, [rbp+0]
    test eax, eax
    jne .L.if.body..00000024 # if eax != 0 { jmp body }
.L.if.body..00000024:
.L.if.else..00000024:
    # global.get __heap_base i32
    mov eax, dword ptr [rip+$G.__heap_base]
...
.L.if.begin..00000026:
    mov eax, [rbp+0]
    test eax, eax
    je .L.if.end..00000026 # if eax != 0 { jmp end }
.L.if.body..00000026:
    # global.get __heap_base i32
    mov eax, dword ptr [rip+$G.__heap_base]
    mov dword ptr [rbp-8], eax
...
.L.if.begin..0000002A:
    mov eax, [rbp-8]
    test eax, eax
    jne .L.if.body..0000002A # if eax != 0 { jmp body }
.L.if.body..0000002A:
    # i32.const 128
    mov eax, 128
    mov [rbp-16], eax
...
.L.if.begin..0000002C:
    mov eax, [rbp+0]
    test eax, eax
    je .L.if.end..0000002C # if eax != 0 { jmp end }
.L.if.body..0000002C:
    # global.get __heap_base i32
    mov eax, dword ptr [rip+$G.__heap_base]
    mov dword ptr [rbp-8], eax
...
.L.if.begin..0000002E:
    mov eax, [rbp+0]
    test eax, eax
    je .L.if.end..0000002E # if eax != 0 { jmp end }
.L.if.body..0000002E:
    # global.get __heap_base i32
    mov eax, dword ptr [rip+$G.__heap_base]
    mov dword ptr [rbp-8], eax
...
.L.if.begin..00000032:
    mov eax, [rbp+0]
    test eax, eax
    je .L.if.end..00000032 # if eax != 0 { jmp end }
.L.if.body..00000032:
...
.L.if.begin..00000034:
    mov eax, [rbp+0]
    test eax, eax
    jne .L.if.body..00000034 # if eax != 0 { jmp body }
.L.if.body..00000034:
.L.if.else..00000034:
    call .Runtime.panic # unreachable
.L.next..00000034:
...
.L.if.begin..00000036:
    mov eax, [rbp+0]
    test eax, eax
    jne .L.if.body..00000036 # if eax != 0 { jmp body }
.L.if.body..00000036:
.L.if.else..00000036:
    call .Runtime.panic # unreachable
.L.next..00000036:
...
.L.if.begin..00000038:
    mov eax, [rbp+0]
    test eax, eax
    jne .L.if.body..00000038 # if eax != 0 { jmp body }
.L.if.body..00000038:
.L.if.else..00000038:
    call .Runtime.panic # unreachable
.L.next..00000038:
...
.L.if.begin..00000040:
    mov eax, [rbp-24]
    test eax, eax
    jne .L.if.body..00000040 # if eax != 0 { jmp body }
.L.if.body..00000040:
.L.if.else..00000040:
    # local.get b i32
    mov eax, dword ptr [rbp-24]
...
.L.if.begin..00000042:
    mov eax, [rbp-24]
    test eax, eax
    jne .L.if.body..00000042 # if eax != 0 { jmp body }
.L.if.body..00000042:
.L.if.else..00000042:
    # local.get b i32
    mov eax, dword ptr [rbp-24]
...
.L.if.begin..00000044:
    mov eax, [rbp-16]
    test eax, eax
    je .L.if.end..00000044 # if eax != 0 { jmp end }
.L.if.body..00000044:
    # i32.const 0
    mov eax, 0
    mov [rbp-24], eax
...
.L.loop.begin.continue0000004A:
.L.next.continue0000004A:
    # local.get p i32
    mov eax, dword ptr [rbp-32]
    mov dword ptr [rbp-40], eax
...
.L.if.begin..0000004B:
    mov eax, [rbp-32]
    test eax, eax
    je .L.if.end..0000004B # if eax != 0 { jmp end }
.L.if.body..0000004B:
    # local.get p i32
    mov eax, dword ptr [rbp-32]
    mov dword ptr [rbp-40], eax
...
.L.if.begin..0000004D:
    mov eax, [rbp-32]
    test eax, eax
    je .L.if.end..0000004D # if eax != 0 { jmp end }
.L.if.body..0000004D:
    # local.get prevp i32
    mov eax, dword ptr [rbp-16]
    mov dword ptr [rbp-40], eax

.L.block.begin.00000050:
    # local.get p i32
    mov eax, dword ptr [rbp-32]
    mov dword ptr [rbp-48], eax
...
.L.if.begin..00000051:
    mov eax, [rbp-32]
    test eax, eax
    je .L.if.end..00000051 # if eax != 0 { jmp end }
.L.if.body..00000051:
    # i32.const 0
    mov eax, 0
    mov [rbp-40], eax
...
.L.if.begin..00000053:
    mov eax, [rbp-32]
    test eax, eax
    je .L.if.end..00000053 # if eax != 0 { jmp end }
.L.if.body..00000053:
    # local.get block_size i32
    mov eax, dword ptr [rbp-24]
    mov dword ptr [rbp-40], eax
    ...
    add rax, r10
    cmp rax, r11
    jg  .L.if.else..00000056
.L.if.body..00000055:
    mov [rbp-32], rax
    jmp .L.if.end..00000057
.L.if.else..00000056:
    mov rax, -1
    mov [rbp-32], rax
.L.if.end..00000057:
...
.L.if.begin..00000058:
    mov eax, [rbp-32]
    test eax, eax
    je .L.if.end..00000058 # if eax != 0 { jmp end }
.L.if.body..00000058:
    # i32.const 0
    mov eax, 0
    mov [rbp-40], eax
...
.L.if.begin..0000005C:
    mov eax, [rbp-24]
    test eax, eax
    je .L.if.end..0000005C # if eax != 0 { jmp end }
.L.if.body..0000005C:
    # local.get size i32
    mov eax, dword ptr [rbp-8]
    mov dword ptr [rbp-32], eax
...
.L.if.begin..0000005E:
    mov eax, [rbp-24]
    test eax, eax
    je .L.if.end..0000005E # if eax != 0 { jmp end }
.L.if.body..0000005E:
    # local.get size i32
    mov eax, dword ptr [rbp-8]
    mov dword ptr [rbp-32], eax
...
.L.if.begin..00000060:
    mov eax, [rbp+0]
    test eax, eax
    je .L.if.end..00000060 # if eax != 0 { jmp end }
.L.if.body..00000060:
    # local.get freep i32
    mov eax, dword ptr [rbp+16]
    mov dword ptr [rbp-8], eax
...
.L.block.begin.break00000067:
.L.loop.begin.continue00000068:
.L.next.continue00000068:
    # local.get p i32
    mov eax, dword ptr [rbp-8]
    mov dword ptr [rbp-24], eax
...
.L.if.begin..00000069:
    mov eax, [rbp-16]
    test eax, eax
    je .L.if.end..00000069 # if eax != 0 { jmp end }
.L.if.body..00000069:
    jmp .L.next.break
.L.next..00000069:
.L.if.end..00000069:
    ...
    jmp .L.next.continue
.L.loop.end.continue00000068:
.L.next.break00000067:
.L.block.end.break00000067:
    # local.get freep i32
    mov eax, dword ptr [rbp+16]
    mov dword ptr [rbp-24], eax
...
.L.block.begin.break0000006C:
.L.loop.begin.continue0000006D:
.L.next.continue0000006D:
    # local.get bp i32
    mov eax, dword ptr [rbp+16]
    mov dword ptr [rbp-16], eax
...
.L.if.begin..0000006E:
    mov eax, [rbp-8]
    test eax, eax
    je .L.if.end..0000006E # if eax != 0 { jmp end }
.L.if.body..0000006E:
    # local.get bp i32
    mov eax, dword ptr [rbp+16]
    mov dword ptr [rbp-16], eax
...
.L.if.begin..00000070:
    mov eax, [rbp-8]
    test eax, eax
    je .L.if.end..00000070 # if eax != 0 { jmp end }
.L.if.body..00000070:
    jmp .L.next.break
.L.next..00000070:
.L.if.end..00000070:
...
.L.if.begin..00000072:
    mov eax, [rbp-8]
    test eax, eax
    je .L.if.end..00000072 # if eax != 0 { jmp end }
.L.if.body..00000072:
    # local.get bp i32
    mov eax, dword ptr [rbp+16]
    mov dword ptr [rbp-16], eax
...
.L.if.begin..00000074:
    mov eax, [rbp-8]
    test eax, eax
    je .L.if.end..00000074 # if eax != 0 { jmp end }
.L.if.body..00000074:
    jmp .L.next.break
.L.next..00000074:
.L.if.end..00000074:
...
.L.if.begin..00000076:
    mov eax, [rbp-8]
    test eax, eax
    je .L.if.end..00000076 # if eax != 0 { jmp end }
.L.if.body..00000076:
    jmp .L.next.break
.L.next..00000076:
.L.if.end..00000076:
...
.L.if.end..00000072:
    ...
    jmp .L.next.continue
.L.loop.end.continue0000006D:
.L.next.break0000006C:
.L.block.end.break0000006C:
    # local.get bp i32
    mov eax, dword ptr [rbp+16]
    mov dword ptr [rbp-16], eax
...
.L.if.begin..00000078:
    mov eax, [rbp-8]
    test eax, eax
    jne .L.if.body..00000078 # if eax != 0 { jmp body }
.L.if.body..00000078:
    # local.get bp i32
    mov eax, dword ptr [rbp+16]
    mov dword ptr [rbp-16], eax

.L.block.begin.0000007B:
    # local.get bp i32
    mov eax, dword ptr [rbp+16]
    mov dword ptr [rbp-24], eax
...
.L.if.begin..0000007E:
    mov eax, [rbp-8]
    test eax, eax
    jne .L.if.body..0000007E # if eax != 0 { jmp body }
.L.if.body..0000007E:
    # local.get p i32
    mov eax, dword ptr [rbp-8]
    mov dword ptr [rbp-16], eax

.L.block.begin.00000081:
    # local.get p i32
    mov eax, dword ptr [rbp-8]
    mov dword ptr [rbp-24], eax
