...
.Wa.Runtime.write:
    ...
    # 获取标准输出句柄
    cmp r10, 1
    je  .Wa.L.Runtime.write.stdout
    cmp r10, 2
    je  .Wa.L.Runtime.write.stderr
    cmp r10, 0
    je  .Wa.L.Runtime.write.stdin
...
.Wa.L.Runtime.write.gethandle:
    ...
    mov  rdx, r11              # buffer
    mov  r8,  r12              # count
    lea  r9, qword ptr [rbp-8] # lpNumberOfBytesWritten
    mov  qword ptr [rbp-8], 0  # 初始化为 0
    mov  qword ptr [rsp+32], 0 # 第5参数 lpOverlapped = NULL
    call WriteFile
