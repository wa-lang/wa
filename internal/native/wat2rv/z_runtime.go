...
//go:embed assets/native-env-linux-rv64.wa.s
var native_env_linux_rv64_wa_s string

//go:embed assets/native-env-linux-rv64.wz.s
var native_env_linux_rv64_wz_s string

// 生成运行时函数
func (p *wat2rvWorker) buildRuntimeHead(w io.Writer) error {
	var list = []string{
		kRuntimeWrite,
		kRuntimeExit,
		kRuntimeMalloc,
...
func (p *wat2rvWorker) buildRuntimeImpl_panic(w io.Writer) error {
