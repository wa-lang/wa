...
func DecodeModule(source []byte, enabledFeatures api.CoreFeatures) (module *wasm.Module, err error) {
...
func newModuleParser(module *wasm.Module, enabledFeatures api.CoreFeatures) *moduleParser {
