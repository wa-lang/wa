(module $__walang__
	...
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 34320))
	...
	(global $runtime.zptr (mut i32) (i32.const 29320))
	(global $__heap_base i32 (i32.const 34416))
	(func $runtime.throw
		unreachable
	)
	...
	(elem (i32.const 28) $math$rand.Rand.Intn.$bound)
	(elem (i32.const 29) $$math$rand.Rand.$$block.$$OnFree)
	(elem (i32.const 30) $$math$rand.Rand.$ref.underlying.$$OnFree)
	...
	(elem (i32.const 34) $errors._Error.报错信息)
	(elem (i32.const 35) $errors._Error.Error)
	(elem (i32.const 36) $errors.errorString.报错信息)
	(elem (i32.const 37) $errors.errorString.Error)
)
