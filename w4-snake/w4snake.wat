(module $__walang__
	...
	(type $$$fnSig6 (func (param i32) (result i32)))
	...
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 29688))
	...
	(global $math$rand.fe.1 i32 (i32.const 14888))
	(global $math$rand.fn.0 i32 (i32.const 0))
	(global $math$rand.fn.1 i32 (i32.const 15912))
	(global $math$rand.globalRand.0 i32 (i32.const 0))
	(global $math$rand.globalRand.1 i32 (i32.const 16424))
	(global $math$rand.init$guard (mut i32) (i32.const 0))
	(global $math$rand.ke.0 i32 (i32.const 0))
	(global $math$rand.ke.1 i32 (i32.const 16432))
	(global $math$rand.kn.0 i32 (i32.const 0))
	(global $math$rand.kn.1 i32 (i32.const 17456))
	(global $math$rand.rngCooked.0 i32 (i32.const 0))
	(global $math$rand.rngCooked.1 i32 (i32.const 17968))
	(global $math$rand.we.0 i32 (i32.const 0))
	(global $math$rand.we.1 i32 (i32.const 22824))
	(global $math$rand.wn.0 i32 (i32.const 0))
	(global $math$rand.wn.1 i32 (i32.const 23848))
	...
	(global $w4snake.frameCount.1 i32 (i32.const 24360))
	(global $w4snake.fruit.0 i32 (i32.const 0))
	(global $w4snake.fruit.1 i32 (i32.const 24364))
	(global $w4snake.fruitSprite.0 i32 (i32.const 0))
	(global $w4snake.fruitSprite.1 i32 (i32.const 24368))
	(global $w4snake.init$guard (mut i32) (i32.const 0))
	(global $w4snake.randInt.0 i32 (i32.const 0))
	(global $w4snake.randInt.1 i32 (i32.const 24384))
	(global $w4snake.sfxEat.0 i32 (i32.const 0))
	(global $w4snake.sfxEat.1 i32 (i32.const 24396))
	(global $w4snake.snake.0 i32 (i32.const 0))
	(global $w4snake.snake.1 i32 (i32.const 24432))
	(global $runtime.zptr (mut i32) (i32.const 24744))
	(global $__heap_base i32 (i32.const 29760))
	(func $runtime.throw
		unreachable
	)
	...
	(elem (i32.const 19) $math$rand.Rand.Intn.$bound)
	(elem (i32.const 20) $$math$rand.Rand.$$block.$$onFree)
	(elem (i32.const 21) $$math$rand.Rand.$ref.underlying.$$onFree)
	(elem (i32.const 22) $math$rand.rngSource.Int63)
	(elem (i32.const 23) $math$rand.rngSource.Seed)
	(elem (i32.const 24) $math$rand.rngSource.Uint64)
	(elem (i32.const 25) $errors.errorString.Error)
)
