(module $__walang__
	...
	(elem (i32.const 20) $math$rand.Rand.Intn.$bound)
	(elem (i32.const 21) $$math$rand.Rand.$$block.$$onFree)
	(elem (i32.const 22) $$math$rand.Rand.$ref.underlying.$$onFree)
	(elem (i32.const 23) $$i`0`.$array1.underlying.$$onFree)
	(elem (i32.const 24) $math$rand.rngSource.Int63)
	(elem (i32.const 25) $math$rand.rngSource.Seed)
	(elem (i32.const 26) $math$rand.rngSource.Uint64)
	(elem (i32.const 27) $errors.errorString.Error)
)
