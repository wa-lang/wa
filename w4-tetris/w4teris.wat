(module $__walang__
	...
	(type $$$fnSig1 (func (param i32) (param i32) (result i32 i32 i32)))
	...
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 46192))
	...
	(global $strconv.ErrRange.1 i32 (i32.const 14984))
	(global $strconv.ErrSyntax.0 i32 (i32.const 0))
	(global $strconv.ErrSyntax.1 i32 (i32.const 15000))
	(global $strconv.detailedPowersOfTen.0 i32 (i32.const 0))
	(global $strconv.detailedPowersOfTen.1 i32 (i32.const 15016))
	(global $strconv.f64info.0 i32 (i32.const 0))
	(global $strconv.f64info.1 i32 (i32.const 26152))
	(global $strconv.float32info.0 i32 (i32.const 0))
	(global $strconv.float32info.1 i32 (i32.const 26164))
	(global $strconv.float32pow10.0 i32 (i32.const 0))
	(global $strconv.float32pow10.1 i32 (i32.const 26176))
	(global $strconv.float64pow10.0 i32 (i32.const 0))
	(global $strconv.float64pow10.1 i32 (i32.const 26224))
	(global $strconv.init$guard (mut i32) (i32.const 0))
	(global $strconv.isGraphic.0 i32 (i32.const 0))
	(global $strconv.isGraphic.1 i32 (i32.const 26408))
	(global $strconv.isNotPrint16.0 i32 (i32.const 0))
	(global $strconv.isNotPrint16.1 i32 (i32.const 26440))
	(global $strconv.isNotPrint32.0 i32 (i32.const 0))
	(global $strconv.isNotPrint32.1 i32 (i32.const 26704))
	(global $strconv.isPrint16.0 i32 (i32.const 0))
	(global $strconv.isPrint16.1 i32 (i32.const 26894))
	(global $strconv.isPrint32.0 i32 (i32.const 0))
	(global $strconv.isPrint32.1 i32 (i32.const 27764))
	(global $strconv.leftcheats.0 i32 (i32.const 0))
	(global $strconv.leftcheats.1 i32 (i32.const 29636))
	(global $strconv.optimize.0 i32 (i32.const 0))
	(global $strconv.optimize.1 i32 (i32.const 30612))
	(global $strconv.powtab.0 i32 (i32.const 0))
	(global $strconv.powtab.1 i32 (i32.const 30616))
	(global $strconv.u64pow10.0 i32 (i32.const 0))
	(global $strconv.u64pow10.1 i32 (i32.const 30656))
	(global $syscall$wasm4.init$guard (mut i32) (i32.const 0))
	(global $unicode$utf8.acceptRanges.0 i32 (i32.const 0))
	(global $unicode$utf8.acceptRanges.1 i32 (i32.const 30816))
	(global $unicode$utf8.first.0 i32 (i32.const 0))
	(global $unicode$utf8.first.1 i32 (i32.const 30848))
	(global $unicode$utf8.init$guard (mut i32) (i32.const 0))
	(global $w4teris.CLEAR_SCORES.0 i32 (i32.const 0))
	(global $w4teris.CLEAR_SCORES.1 i32 (i32.const 31104))
	(global $w4teris.LEVEL_SPEED.0 i32 (i32.const 0))
	(global $w4teris.LEVEL_SPEED.1 i32 (i32.const 31120))
	(global $w4teris.PIECE_COLORS.0 i32 (i32.const 0))
	(global $w4teris.PIECE_COLORS.1 i32 (i32.const 31136))
	(global $w4teris.PIECE_COORDS.0 i32 (i32.const 0))
	(global $w4teris.PIECE_COORDS.1 i32 (i32.const 31152))
	(global $w4teris.PIECE_SPRITES.0 i32 (i32.const 0))
	(global $w4teris.PIECE_SPRITES.1 i32 (i32.const 31168))
	(global $w4teris.best.0 i32 (i32.const 0))
	(global $w4teris.best.1 i32 (i32.const 31184))
	(global $w4teris.board.0 i32 (i32.const 0))
	(global $w4teris.board.1 i32 (i32.const 31188))
	(global $w4teris.clearAnimationDelay.0 i32 (i32.const 0))
	(global $w4teris.clearAnimationDelay.1 i32 (i32.const 31388))
	(global $w4teris.clearAnimationRowMask.0 i32 (i32.const 0))
	(global $w4teris.clearAnimationRowMask.1 i32 (i32.const 31392))
	(global $w4teris.gameover.0 i32 (i32.const 0))
	(global $w4teris.gameover.1 i32 (i32.const 31396))
	(global $w4teris.gameoverElapsed.0 i32 (i32.const 0))
	(global $w4teris.gameoverElapsed.1 i32 (i32.const 31400))
	(global $w4teris.gravityDelay.0 i32 (i32.const 0))
	(global $w4teris.gravityDelay.1 i32 (i32.const 31404))
	(global $w4teris.holdingDirection.0 i32 (i32.const 0))
	(global $w4teris.holdingDirection.1 i32 (i32.const 31408))
	(global $w4teris.init$guard (mut i32) (i32.const 0))
	(global $w4teris.lastGamepadState.0 i32 (i32.const 0))
	(global $w4teris.lastGamepadState.1 i32 (i32.const 31412))
	(global $w4teris.level.0 i32 (i32.const 0))
	(global $w4teris.level.1 i32 (i32.const 31416))
	(global $w4teris.lines.0 i32 (i32.const 0))
	(global $w4teris.lines.1 i32 (i32.const 31420))
	(global $w4teris.nextPieceType.0 i32 (i32.const 0))
	(global $w4teris.nextPieceType.1 i32 (i32.const 31424))
	(global $w4teris.piece.0 i32 (i32.const 0))
	(global $w4teris.piece.1 i32 (i32.const 31428))
	(global $w4teris.repeatDelay.0 i32 (i32.const 0))
	(global $w4teris.repeatDelay.1 i32 (i32.const 31472))
	(global $w4teris.score.0 i32 (i32.const 0))
	(global $w4teris.score.1 i32 (i32.const 31476))
	(global $w4teris.seed.0 i32 (i32.const 0))
	(global $w4teris.seed.1 i32 (i32.const 31480))
	(global $runtime.zptr (mut i32) (i32.const 35000))
	(global $__heap_base i32 (i32.const 46240))
	(func $runtime.throw
		unreachable
	)
	...
	(elem (i32.const 15) $$errors.errorString.$$onFree)
	(elem (i32.const 16) $$.error.underlying.$$onFree)
	(elem (i32.const 17) $$strconv.NumError.$$onFree)
	(elem (i32.const 18) $$u8.$slice.underlying.$$onFree)
	(elem (i32.const 19) $$strconv.decimalSlice.$$onFree)
	(elem (i32.const 20) $errors.errorString.Error)
	(elem (i32.const 21) $strconv.NumError.Error)
)
