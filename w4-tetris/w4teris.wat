(module $__walang__
	...
	(elem (i32.const 16) $$errors.errorString.$$onFree)
	(elem (i32.const 17) $$.error.underlying.$$onFree)
	(elem (i32.const 18) $$strconv.NumError.$$onFree)
	(elem (i32.const 19) $$u8.$slice.underlying.$$onFree)
	(elem (i32.const 20) $$strconv.decimalSlice.$$onFree)
	(elem (i32.const 21) $$i`0`.$array1.underlying.$$onFree)
	(elem (i32.const 22) $errors.errorString.Error)
	(elem (i32.const 23) $strconv.NumError.Error)
)
