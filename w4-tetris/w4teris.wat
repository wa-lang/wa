(module $__walang__
	...
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 53520))
	...
	(global $runtime.zptr (mut i32) (i32.const 42272))
	(global $__heap_base i32 (i32.const 53584))
	(func $runtime.throw
		unreachable
	)
