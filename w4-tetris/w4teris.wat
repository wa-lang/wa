(module $__walang__
	...
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 53328))
	...
	(global $runtime.zptr (mut i32) (i32.const 42136))
	(global $__heap_base i32 (i32.const 53376))
	(func $runtime.throw
		unreachable
	)
