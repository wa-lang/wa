(module $__walang__
	...
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 45792))
	...
	(global $runtime.zptr (mut i32) (i32.const 34600))
	(global $__heap_base i32 (i32.const 45840))
	(func $runtime.throw
		unreachable
	)
