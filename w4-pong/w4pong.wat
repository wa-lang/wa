(module $__walang__
	...
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 55496))
	...
	(elem (i32.const 27) $$.error.underlying.$$onFree)
	(elem (i32.const 28) $$strconv.NumError.$$onFree)
	(elem (i32.const 29) $$u8.$slice.underlying.$$onFree)
	(elem (i32.const 30) $$strconv.decimalSlice.$$onFree)
	(elem (i32.const 31) $math$rand.rngSource.Int63)
	(elem (i32.const 32) $math$rand.rngSource.Seed)
	(elem (i32.const 33) $math$rand.rngSource.Uint64)
	(elem (i32.const 34) $errors.errorString.Error)
	(elem (i32.const 35) $strconv.NumError.Error)
)
