(module $__walang__
	...
	(export "w4snake.游戏帧数.0" (global $w4snake.游戏帧数.0))
	(export "w4snake.游戏帧数.1" (global $w4snake.游戏帧数.1))
	(export "w4snake.进食的声音.0" (global $w4snake.进食的声音.0))
	(export "w4snake.进食的声音.1" (global $w4snake.进食的声音.1))
	(export "w4snake.食物位置.0" (global $w4snake.食物位置.0))
	(export "w4snake.食物位置.1" (global $w4snake.食物位置.1))
	(export "w4snake.食物图像.0" (global $w4snake.食物图像.0))
	(export "w4snake.食物图像.1" (global $w4snake.食物图像.1))
	(export "w4snake.饿死鬼.0" (global $w4snake.饿死鬼.0))
	(export "w4snake.饿死鬼.1" (global $w4snake.饿死鬼.1))
	(table 35 funcref)
	...
	(global $$wa.runtime._interfaceCount (mut i32) (i32.const 5))
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 34352))
	...
	(global $w4snake.准备$guard (mut i32) (i32.const 0))
	(global $w4snake.游戏帧数.0 i32 (i32.const 0))
	(global $w4snake.游戏帧数.1 i32 (i32.const 24376))
	(global $w4snake.进食的声音.0 i32 (i32.const 0))
	(global $w4snake.进食的声音.1 i32 (i32.const 24380))
	(global $w4snake.食物位置.0 i32 (i32.const 0))
	(global $w4snake.食物位置.1 i32 (i32.const 24416))
	(global $w4snake.食物图像.0 i32 (i32.const 0))
	(global $w4snake.食物图像.1 i32 (i32.const 24420))
	(global $w4snake.饿死鬼.0 i32 (i32.const 0))
	(global $w4snake.饿死鬼.1 i32 (i32.const 24436))
	(global $数学$随机数.准备$guard (mut i32) (i32.const 0))
	(global $门阀$瓦力四像门.准备$guard (mut i32) (i32.const 0))
	(global $runtime.zptr (mut i32) (i32.const 29352))
	(global $__heap_base i32 (i32.const 34448))
	(func $runtime.throw
		unreachable
	)
	...
	(func $math$rand.Intn (param $n i32) (result i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$ret_0 i32)
		(local $$t0.0 i32)
	...
	(func $w4snake.启动游戏 (export "start")
		(local $$block_selector i32)
		(local $$current_block i32)
		block $$BlockFnBody
			loop $$BlockDisp
	...
	(func $w4snake.处理输入 (export "w4snake.处理输入")
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1 i32)
	...
	(func $$w4snake.点.$slice.append (param $x.0 i32) (param $x.1 i32) (param $x.2 i32) (param $x.3 i32) (param $y.0 i32) (param $y.1 i32) (param $y.2 i32) (param $y.3 i32) (result i32 i32 i32 i32)
		(local $item.0 i32)
		(local $item.1 i32)
		(local $x_len i32)
		(local $y_len i32)
	...
	(func $w4snake.更新游戏状态 (export "update")
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1 i32)
					...
					block $$Block_4
						block $$Block_3
							block $$Block_2
								...
								i32.const 0
								i32.const 24436
								call $w4snake.贪吃蛇.美图秀秀
								i32.const 1
								i32.const 2
								i32.const 3
								i32.const 4
								call $门阀$瓦力四像门.设置绘图颜色
								i32.const 24420
								i32.load
								call $runtime.Block.Retain
								i32.const 24420
	...
	(func $数学$随机数.范围内整数 (param $范围 i32) (result i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$ret_0 i32)
		(local $$t0 i32)
	...
	(func $门阀$瓦力四像门.位图块传输 (param $精灵.0 i32) (param $精灵.1 i32) (param $精灵.2 i32) (param $精灵.3 i32) (param $经 i32) (param $纬 i32) (param $宽 i32) (param $高 i32) (param $控制位 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		block $$BlockFnBody
			loop $$BlockDisp
	...
	(func $门阀$瓦力四像门.写调试板 (param $a0 i32) (param $a1 i32) (param $a2 i32) (param $a3 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		block $$BlockFnBody
			loop $$BlockDisp
	...
	(func $门阀$瓦力四像门.播放声音 (param $frequency i32) (param $duration i32) (param $volume i32) (param $flags i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		block $$BlockFnBody
			loop $$BlockDisp
	...
	(func $门阀$瓦力四像门.画矩形 (param $x i32) (param $y i32) (param $width i32) (param $height i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		block $$BlockFnBody
			loop $$BlockDisp
	...
	(func $门阀$瓦力四像门.设置绘图颜色 (param $甲 i32) (param $乙 i32) (param $丙 i32) (param $丁 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		block $$BlockFnBody
			loop $$BlockDisp
	...
	(func $门阀$瓦力四像门.读取控制键1 (result i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$ret_0 i32)
		(local $$t0 i32)
	...
	(func $w4snake.声音.播放 (param $我的.0 i32) (param $我的.1 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1.0 i32)
	...
	(func $w4snake.贪吃蛇.往上游动 (param $我的.0 i32) (param $我的.1 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1 i32)
	...
	(func $w4snake.贪吃蛇.往下游动 (param $我的.0 i32) (param $我的.1 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1 i32)
	...
	(func $w4snake.贪吃蛇.往右游动 (param $我的.0 i32) (param $我的.1 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1 i32)
	...
	(func $w4snake.贪吃蛇.往左游动 (param $我的.0 i32) (param $我的.1 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1 i32)
	...
	(func $w4snake.贪吃蛇.更新 (param $我的.0 i32) (param $我的.1 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1 i32)
	...
	(func $w4snake.贪吃蛇.死了吗 (param $我的.0 i32) (param $我的.1 i32) (result i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$ret_0 i32)
		(local $$t0 i32)
	...
	(func $w4snake.贪吃蛇.美图秀秀 (param $我的.0 i32) (param $我的.1 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0.0 i32)
		(local $$t0.1 i32)
	...
	(func $w4snake.贪吃蛇.重生 (param $我的.0 i32) (param $我的.1 i32)
		(local $$block_selector i32)
		(local $$current_block i32)
		(local $$t0 i32)
		(local $$t1.0 i32)
	...
	(elem (i32.const 26) $$errors._Error.$$OnFree)
	(elem (i32.const 27) $$errors.errorString.$$OnFree)
	(elem (i32.const 28) $math$rand.rngSource.Int63)
	(elem (i32.const 29) $math$rand.rngSource.Seed)
	(elem (i32.const 30) $math$rand.rngSource.Uint64)
	(elem (i32.const 31) $errors._Error.报错信息)
	(elem (i32.const 32) $errors._Error.Error)
	(elem (i32.const 33) $errors.errorString.报错信息)
