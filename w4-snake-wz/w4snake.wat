(module $__walang__
	...
	(global $$wa.runtime._itabsPtr (mut i32) (i32.const 34160))
	...
	(global $runtime.zptr (mut i32) (i32.const 29216))
	(global $__heap_base i32 (i32.const 34224))
	(func $runtime.throw
		unreachable
	)
	...
	(elem (i32.const 27) $math$rand.rngSource.Int63)
	(elem (i32.const 28) $math$rand.rngSource.Seed)
	(elem (i32.const 29) $math$rand.rngSource.Uint64)
	(elem (i32.const 30) $errors.errorString.Error)
)
