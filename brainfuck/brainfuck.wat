(module $__walang__
  ...
  (import "syscall_js" "print_position" (func $syscall$js.__import__print_position (param i32)))
...
(func $syscall$js.PrintPosition (param $pos i32)
  (local $$block_selector i32)
  (local $$current_block i32)
  block $$BlockFnBody
    loop $$BlockDisp
      block $$Block_0
        ...
        local.get $pos
        call $syscall$js.__import__print_position
