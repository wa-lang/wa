...
class WaApp {
  ...
  async init() {
    ...
    try {
      ...
      this.Canvas_OnKeyDown = function(id, key) {
        // 准备参数
        let params = [];
        params.push(id);
params.push(key);
        ...
        let res = this._wasm_inst.exports["snake.Canvas_OnKeyDown"](...params);
      ...
      this.Canvas_OnKeyUp = function(id, key) {
        // 准备参数
        let params = [];
        params.push(id);
params.push(key);
        ...
        let res = this._wasm_inst.exports["snake.Canvas_OnKeyUp"](...params);
      ...
      this.Canvas_OnMouseDown = function(id, x, y) {
        // 准备参数
        let params = [];
        params.push(id);
params.push(x);
params.push(y);
        ...
        let res = this._wasm_inst.exports["snake.Canvas_OnMouseDown"](...params);
      ...
      this.Canvas_OnMouseUp = function(id, x, y) {
        // 准备参数
        let params = [];
        params.push(id);
params.push(x);
params.push(y);
        ...
        let res = this._wasm_inst.exports["snake.Canvas_OnMouseUp"](...params);
      ...
      this.Step = function() {
        ...
        let res = this._wasm_inst.exports["snake.Step"](...params);
      ...
      this.main = function() {
        ...
        let res = this._wasm_inst.exports["snake.main"](...params);
